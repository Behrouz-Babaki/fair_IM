...
def MIP_IM(attribute, input_graph, samples, output_file, log_file ):
    budget = 25
    ...
    with open(input_graph, "rb") as f:
        ...
        for label in label_dict.keys():
            ...
            model.addConstr(expr, GRB.GREATER_EQUAL, label_size * len(samples) * min_value)
        ...
        with open(log_file, "w") as of:  
            ...
            print('sample_size\t%d'%len(samples), file = of)
...
if __name__ == '__main__':
    ...
    MIP_IM(args.attribute, args.input_graph, samples, args.output_file, args.log_file)
