...
RUNNER="../../code/MIP/Runner_DC.py"
RESULTDIR="./results"
NETWORKDIR="../../code/MIP/data/networks_prob"

$RUNNER {attribute} {n_samples} $NETWORKDIR/graph_spa_500_{graph_index}.pickle $RESULTDIR/output_{job_id}.txt $RESULTDIR/log_{job_id}.txt
source deactivate
'''
